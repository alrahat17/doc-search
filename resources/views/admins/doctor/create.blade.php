                            ...
                            <form action="{{ route('savedoctor')}}" method="POST">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name')}}" class="form-control" placeholder="Enter the first name">
                                </div>
                                <div class="form-group">
                                    <label for="last_name" class="form-control-label">*Last Name</label>
                                    <input type="text" name="last_name" id="last_name" value="{{ old('last_name')}}" class="form-control" placeholder="Enter the last name">
                                ...
                                <div class="form-group">
                                    <input type="tel" name="phone_portable" id="phone_portable" class="form-control">
                                </div>
                                 <div class="form-group">
                                 	<div class="mb-4">                 
