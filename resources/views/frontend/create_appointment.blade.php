            ...
            <ul class="navbar-nav ">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item "> {{Auth::user()->first_name}}</a>
        ...
        <div class="col-sm-12" id="ss_registration_content">
          <div class="ss_registration_content_top">
            ...
            <div class="doctor_booking">
              ...
              <form class="form-inline" method="POST" action="{{URL::to('/save_appointment')}}">
                {{csrf_field()}}  
