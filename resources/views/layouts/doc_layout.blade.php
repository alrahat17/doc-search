...
<html lang="en">
 <head>
   ...
   <link rel="stylesheet" type="text/css" href="{{ asset('doc_front/assets/css/intlTelInput.min.css')}}"/>
               ...
               <form class="form-inline my-2 my-lg-0 inline-search">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item "> {{$doc_info->title }} {{ $doc_info->first_name}} {{ $doc_info->last_name}}</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item " href="{{ route('doctorProfile') }}"> <i class="fa fa-user"></i> See my profile</a>
                    <a class="dropdown-item" href="{{ route('doctor.edit',$doc_info->id )}}"><i class="fa fa-pencil"> </i> Edit my profile</a>
   ...
   <!--  <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" ></script> -->
    ...
    <script>
       ...
       $(document).ready(function() {
        $(".ss_fixed_price").click(function(){
            $(".ss_variable_price_val").hide();
            });

            $(".ss_variable_price").click(function(){
            $(".ss_variable_price_val").show();
        });
